...
PROTOBUF_NAMESPACE_OPEN
template<> ::filetransfer::FileRequest* Arena::CreateMaybeMessage<::filetransfer::FileRequest>(Arena*);
template<> ::filetransfer::FileResponse* Arena::CreateMaybeMessage<::filetransfer::FileResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace filetransfer {
...
class FileRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:filetransfer.FileRequest) */ {
 public:
...
class FileResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:filetransfer.FileResponse) */ {
 public:
...
inline const std::string& FileRequest::content() const {
  // @@protoc_insertion_point(field_get:filetransfer.FileRequest.content)
...
void FileRequest::set_content(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.content_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:filetransfer.FileRequest.content)
}
inline std::string* FileRequest::mutable_content() {
  std::string* _s = _internal_mutable_content();
  // @@protoc_insertion_point(field_mutable:filetransfer.FileRequest.content)
  return _s;
}
...
inline std::string* FileRequest::release_content() {
  // @@protoc_insertion_point(field_release:filetransfer.FileRequest.content)
...
inline void FileRequest::set_allocated_content(std::string* content) {
  ...
  // @@protoc_insertion_point(field_set_allocated:filetransfer.FileRequest.content)
}
...
inline bool FileResponse::success() const {
  // @@protoc_insertion_point(field_get:filetransfer.FileResponse.success)
...
inline void FileResponse::set_success(bool value) {
  ...
  // @@protoc_insertion_point(field_set:filetransfer.FileResponse.success)
}
